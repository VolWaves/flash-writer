...
#define UEVT_FLASH_BASE (0x0300)
#define UEVT_FLASH_ERROR (UEVT_FLASH_BASE | 0x01)
#define UEVT_FLASH_SUCCESS (UEVT_FLASH_BASE | 0x02)
#define UEVT_CTL_FLASH_START (UEVT_FLASH_BASE | 0x81)
#define UEVT_CTL_FLASH_CONTINUE (UEVT_FLASH_BASE | 0x82)
#define UEVT_CTL_FLASH_CHECK (UEVT_FLASH_BASE | 0x83)
